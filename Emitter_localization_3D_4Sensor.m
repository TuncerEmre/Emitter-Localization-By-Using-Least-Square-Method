...
x_position_of_sensors = [30, 30, 30, 35];

y_position_of_sensors = [30, 80, 80, 35];

z_position_of_sensors = [30, 30, 80, 85];
...
scatter3(x_position_of_sensors(3), y_position_of_sensors(3), z_position_of_sensors(3), 'Marker', 'o', 'MarkerFaceColor', 'r','MarkerEdgeColor','r', 'DisplayName', 'Sensor 3');
scatter3(x_position_of_sensors(4), y_position_of_sensors(4), z_position_of_sensors(4), 'Marker', 'o', 'MarkerFaceColor', 'r','MarkerEdgeColor','r', 'DisplayName', 'Sensor 4');
